...
const CardInCart = ({ articul, imgSrc, title, price, isPriceShow, onClickHandler, hasQuantityBtns, hasTrashIcon, orderModalStyles }) => {
    ...
    return (
        <li className={`${orderModalStyles ? CheckoutList.item : styles.item} dark:bg-[#27216d] dark:text-white`}>
            ...
            <div className={orderModalStyles ? CheckoutList.itemInfo : styles.itemInfo}>
                <h3 className={`${styles.itemTitle} dark:text-white text-xl font-semibold`}>{title}</h3>
