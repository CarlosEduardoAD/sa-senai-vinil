    ...
    <section className="relative dark:bg-[#151617]">
      ...
      >
        ...
        >
          ...
          <g fill="url(#illustration-01)" fillRule="evenodd">
            <circle cx="1130" cy="228" r="128" />
            <circle cx="311" cy="203" r="64" />
          </g>
        </svg>
      </div>
      ...
      <div className="max-w-6xl sm:max-w-full mx-auto px-4 sm:px-6">
        ...
        <div className="pt-32 pb-48 sm:pb-12 md:pt-40 md:pb-20">
          ...
          <div className="text-center pb-12 md:pb-16">
            ...
            <div className="max-w-3xl mx-auto">
              ...
              >
                ...
                noite ? Estamos aqui para colocar você de volta à pista !
              </p>
              <div
          ...
          <div className="flex flex-col items-center justify-center mt-24 max-x-md text-black dark:text-white font-inter sm:text-3xl text-2xl font-bold text-center">
            Catálogo curado pela nossa comunidade...{" "}
            <span className="bg-clip-text text-transparent bg-gradient-to-r text-5xl sm:text-7xl py-8 sm:py-12 from-blue-700 to-teal-250 dark:from-blue-700 dark:to-indigo-900">
              &nbsp; Várias &nbsp;
            </span>
            ...
            opções para todos os gostos e todas as idades.
          </div>
        </div>
      </div>
    </section>
