...
function HeroCart() {
  ...
  return (
    <>
    <div className="dark:bg-[#151617] max-w-6xl xs:max-w-full min-h-screen">
        ...
        <div className="flex flex-col flex-wrap xs:pr-0 pr-36 font-semibold font-inter pt-80 xs:pt-0">
          <div className="border-t w-[150px] pt-3 border-gray-400">
            <ul className="space-y-2 dark:text-white text-black">
              <li className="md:text-2xl text-2xl whitespace-nowrap">Produto: <span className="text-xl">{response.produto}</span></li>
              <li className="md:text-2xl text-2xl whitespace-nowrap">Preço: <span className="text-xl">{response.preco}</span></li>
              <li className="md:text-2xl text-2xl whitespace-wrap ">Descrição: <span className="text-sm">{response.descricao}</span></li>
            </ul>
          </div>
        </div>
      </section>
